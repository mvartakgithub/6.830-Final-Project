...
cycles), $C(\cdot)$ is the component containing a node, $d$ is the damping
factor, and $n$ is the normalizing factor.
...
Microsoft Academic Search, ACM Digital Library and CiteSeer.

\subsection{Methodology}

We obtained information about important papers on 6 topics from experts in the
respective areas. We then manually picked weights, given in Table \ref{weights}
that gave good results for all 6 topics. 
...
Figures \ref{relevance2} shows the relevance ratio across all search engines.
...
\caption{Relevance of search results grouped as Highly Relevant, Moderately
...
weaker compared to other search engines. However, our preliminary user study
shows that PubCrawl can find relevant documents and effectively trade off
PageRank and text indexing scores.
